...
export const TEAMS_INFO: TeamInfo[] = [
  ...
  },
  {
    ...
    flag: 'gb',
    teamChief: 'Jack Brabham / Bernie Ecclestone',
    technicalChief: 'Ron Tauranac / Gordon Murray',
    chassis: 'BT19, BT24, BT49, BT52',
  ...
  },
  {
    ...
    flag: 'gb',
    teamChief: 'Charles & John Cooper',
    technicalChief: 'Owen Maddock',
    chassis: 'T51, T53, T60',
    powerUnit: 'Climax',
    firstTeamEntry: 1950,
    worldChampionships: 2,
    highestRaceFinish: '1 (x16)',
    polePositions: 11,
    fastestLaps: 14,
  },
  {
    ...
    flag: 'gb',
    teamChief: 'Alfred Owen / Louis Stanley',
    technicalChief: 'Tony Rudd',
    chassis: 'P57, P261, P160',
    powerUnit: 'BRM',
    firstTeamEntry: 1950,
    worldChampionships: 1,
    highestRaceFinish: '1 (x17)',
    polePositions: 11,
    fastestLaps: 15,
  },
  {
    ...
    flag: 'gb',
    teamChief: 'Ken Tyrrell',
    technicalChief: 'Derek Gardner / Harvey Postlethwaite',
    chassis: 'Tyrrell 003, 006, P34',
    powerUnit: 'Ford Cosworth DFV',
    firstTeamEntry: 1968,
    worldChampionships: 1,
    highestRaceFinish: '1 (x23)',
    polePositions: 14,
    fastestLaps: 20,
  },
  {
    ...
    flag: 'fr',
    teamChief: 'Ken Tyrrell / Jean-Luc Lagardère',
    technicalChief: 'Bernard Boyer',
    chassis: 'MS10, MS80, MS120',
    powerUnit: 'Ford Cosworth DFV / Matra V12',
    firstTeamEntry: 1966,
    worldChampionships: 1,
    highestRaceFinish: '1 (x12)',
    polePositions: 5,
    fastestLaps: 12,
  },
  {
    ...
    identifier: 'Vanwall',
    name: 'Vanwall',
    fullName: 'Vandervell Products Limited',
    base: 'Acton, United Kingdom',
    flag: 'gb',
    teamChief: 'Tony Vandervell',
    technicalChief: 'Frank Costin',
    chassis: 'VW57, VW58',
    powerUnit: 'Vanwall',
    firstTeamEntry: 1954,
    worldChampionships: 1,
  ...
  },
  {
    ...
    identifier: 'Benetton',
    name: 'Benetton',
    fullName: 'Benetton Formula Limited',
    base: 'Enstone, United Kingdom',
    flag: 'gb',
    teamChief: 'Flavio Briatore',
    technicalChief: 'Ross Brawn / Pat Symonds',
    chassis: 'B194, B195',
    powerUnit: 'Ford Zetec-R / Renault V10',
    firstTeamEntry: 1986,
    worldChampionships: 1,
    highestRaceFinish: '1 (x27)',
    polePositions: 16,
    fastestLaps: 36,
  },
];
